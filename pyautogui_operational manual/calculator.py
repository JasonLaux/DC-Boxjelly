'''
    ...
    The application is for the manual making, illustration, screenshots, and other user behaviors.
...
def start_application():
  root = Tk()
  app = calc(root)
  root.eval('tk::PlaceWindow . center') # bring the window in the center of the primary monitor
